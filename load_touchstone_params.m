function [F,P,TYPE,IMP,N] = load_touchstone_params(filename)
% LOAD_TOUCHSTONE_PARAMS  Load network parameters from a touchstone data file
%   [F,P,TYPE,IMP,N] = LOAD_TOUCHSTONE_PARAMS(filename)
...
while true
    ...
    if ~isempty(line)
        ...
        elseif N_PORTS<=2
            ...
            DATA = vertcat(DATA, row); %#ok<AGROW> 
        end
    end
end
